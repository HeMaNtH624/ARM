...
u8 i2c_read(void);
void eeprom_page_write(u8, u8, u8*, u8);
u8* eeprom_page_read(u8, u8, u8);
u8 master_ack(void);
...
int main()
{
	...
	eeprom_page_write(0x50, 0x00, "HEMANTH", 4);
	data=eeprom_page_read(0x50, 0x00, 8);
